...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: YL76Yi4QdfS4/css
...
function PlasmicFaq__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__bhHuB)}>
        <div className={classNames(projectcss.all, sty.freeBox__uElfj)}>
          <div className={classNames(projectcss.all, sty.freeBox__kkxvs)}>
            {renderPlasmicSlot({

...
import Plan from "../../Plan"; // plasmic-import: btbRFu7u_upz/component
...
import Faq from "../../Faq"; // plasmic-import: YL76Yi4QdfS4/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: uVgRnyhC1p2h/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column___4H3Id)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__zuq0X)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__hR2Ew)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column__zjqjr)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__cznmy)}
                  description={
                    <div
                      className={classNames(projectcss.all, sty.freeBox__vtAle)}
                    >
                      <Bullet
                        className={classNames(
                          "__wab_instance",
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__zqpip)}
                    color={"blue"}
                    submitsForm={true}
                  >
                    {"Get started"}
              ...
              <div className={classNames(projectcss.all, sty.column__waRe)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__rA7Zw)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button___69FjG)}
                    color={"outlineBlue"}
                    submitsForm={true}
                  >
                    {"Get started"}
          ...
          <Section
            ...
            title={"FAQ"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__eznb6)}>
              <Faq
                className={classNames("__wab_instance", sty.faq__wsZxa)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__v9ZZd)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq___5Hkkx)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >

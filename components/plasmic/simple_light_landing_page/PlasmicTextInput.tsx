...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: imfkMeZlwEFG/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__x7NtO)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__bYdb5)}
              role={"img"}
            />
          ),

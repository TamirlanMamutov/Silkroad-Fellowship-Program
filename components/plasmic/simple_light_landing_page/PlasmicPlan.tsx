...
import BaseCard from "../../BaseCard"; // plasmic-import: 5tAIcjhnKqFF/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: btbRFu7u_upz/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___4ZLl)}>
        <div className={classNames(projectcss.all, sty.freeBox__jyYs)}>
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__bix1K)}>
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__k4W96)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__dTZcu)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__cgAx3)}
                />
              </div>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox__a7Ir)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__qCsHg)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}

...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: VWYTCwolppmH/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: Cv5VkuFraSwl/icon
...
function PlasmicHomeCta__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jdhtF)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__m00Oe)}>
          <TextInput
      ...
      <div className={classNames(projectcss.all, sty.freeBox___8Z1Tk)}>
        <SphereIcon

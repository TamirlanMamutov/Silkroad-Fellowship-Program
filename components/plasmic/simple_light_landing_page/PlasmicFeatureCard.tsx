...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: Uh0mjiM15tX3/css
...
function PlasmicFeatureCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__i8O2D, {
          [sty.freeBoxlong__i8O2Dk82R]: hasVariant($state, "long", "long")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__dp36, {
            [sty.freeBoxlong__dp36K82R]: hasVariant($state, "long", "long")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qwmxq)}
                role={"img"}
              />
            ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mPd7Q, {
          [sty.freeBoxlong__mPd7Qk82R]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ef6S, {
          [sty.freeBoxlong__ef6SK82R]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__mcLca)}
              role={"img"}
            />
          ),

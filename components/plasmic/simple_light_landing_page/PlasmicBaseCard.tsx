...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 5tAIcjhnKqFF/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__tWg8A, {
          [sty.freeBoxlong__tWg8AljBbM]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__uGbDm, {
          [sty.freeBoxlong__uGbDMljBbM]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__sMzz2)}
              role={"img"}
            />
          ),

...
import Avatar from "../../Avatar"; // plasmic-import: IzlRMtMawqk5/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: I7ALZ0ZTsqn6/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: aHbXJhMDmfiT/icon
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__liG4E)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__dukfa)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
